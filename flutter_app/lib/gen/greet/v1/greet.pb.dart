...
import 'greet.pbenum.dart';

export 'package:protobuf/protobuf.dart' show GeneratedMessageGenericExtensions;

export 'greet.pbenum.dart';
...
class MyCustomOption extends $pb.GeneratedMessage {
  factory MyCustomOption({
    SomeEnum? someEnum,
  }) {
    final $result = create();
    if (someEnum != null) {
      $result.someEnum = someEnum;
    }
    return $result;
  }
  MyCustomOption._() : super();
  factory MyCustomOption.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MyCustomOption.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyCustomOption', package: const $pb.PackageName(_omitMessageNames ? '' : 'greet.v1'), createEmptyInstance: create)
    ..e<SomeEnum>(1, _omitFieldNames ? '' : 'someEnum', $pb.PbFieldType.OE, defaultOrMaker: SomeEnum.SOME_ENUM_UNSPECIFIED, valueOf: SomeEnum.valueOf, enumValues: SomeEnum.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  MyCustomOption clone() => MyCustomOption()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MyCustomOption copyWith(void Function(MyCustomOption) updates) => super.copyWith((message) => updates(message as MyCustomOption)) as MyCustomOption;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static MyCustomOption create() => MyCustomOption._();
  MyCustomOption createEmptyInstance() => create();
  static $pb.PbList<MyCustomOption> createRepeated() => $pb.PbList<MyCustomOption>();
  @$core.pragma('dart2js:noInline')
  static MyCustomOption getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MyCustomOption>(create);
  static MyCustomOption? _defaultInstance;

  @$pb.TagNumber(1)
  SomeEnum get someEnum => $_getN(0);
  @$pb.TagNumber(1)
  set someEnum(SomeEnum v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSomeEnum() => $_has(0);
  @$pb.TagNumber(1)
  void clearSomeEnum() => clearField(1);
}
